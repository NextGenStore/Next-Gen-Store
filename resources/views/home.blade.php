...
>
    <div>
        <a href="/src" class="block py-navbar-item pl-5"> NextGenStore </a>
    </div>
    <!-- Responsive Menu -->
    <div
        ...
        <ul>
            <li>
                <a
                    href="/src/index.html"
                    class="block py-5 px-3 transition-colors hover:bg-slate-800">Home</a>
            </li>
            <li>
                <a
                    href="#"
                    class="block py-5 px-4 transition-colors hover:bg-slate-800">Categories</a>
            </li>
            <li>
                <a
                    href="#"
                    class="block py-2 px-3 transition-colors hover:bg-slate-800">Something</a>
            </li>
        </ul>
        <ul>
            <li>
    ...
    <nav class="hidden md:block">
        <ul class="grid grid-flow-col">
            ...
            <li>
                <a
                    href="#"
                    class="block py-navbar-item px-navbar-item hover:bg-slate-900">Categories</a>
            </li>
            <li>
                <a
                    href="#"
                    class="block py-navbar-item px-navbar-item hover:bg-slate-900">Something</a>
            </li>
        </ul>
    </nav>
    <nav class="hidden md:block">
    ...
    <div
        ...
        <div
            ...
            <a href="/src/product.html" class="block overflow-hidden">
                <img src="https://dlcdnwebimgs.asus.com/gain/1F5AFFA6-D3DC-42CA-B37D-03DAAE123012/w750/h470" jsaction="" class="sFlh5c FyHeAf iPVvYb" style="max-width: 750px; height: 298px; margin: 61px 0px; width: 476px;" alt="Gaming Mice &amp; Mouse Pads｜ROG - Republic of Gamers｜Global" jsname="kn3ccd">
            </a>
            <div class="p-2">
                <h3 class="text-lg">
